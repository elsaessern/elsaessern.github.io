...
and
$$\begin{equation}
(c_j)_{\mathbf{\alpha}\mathbf{\beta}} = \delta(\alpha_1,\beta_1)\cdots \delta(\alpha_{j-1},\beta_{j-1}) \delta(\alpha_j,-\beta_j)\deta(\alpha_{j+1},\beta_{j+1})\cdots\delta(\alpha_N,\beta_N).
\end{equation}$$
